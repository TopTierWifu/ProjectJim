...
public class TripleCompressedCobblestone implements Listener{
	...
	public void addRecipe() {
		...
		ItemStack item = CustomItem.TRIPLE_COMPRESSED_COBBLESTONE;
		NamespacedKey key = new NamespacedKey(plugin, "triple_compressed_cobblestone");
		ShapedRecipe r = new ShapedRecipe(key, item);
		
		@SuppressWarnings("deprecation")
		RecipeChoice c = new RecipeChoice.ExactChoice(CustomItem.DOUBLE_COMPRESSED_COBBLESTONE);
